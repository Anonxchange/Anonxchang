...
VALUES
  ('NOVA','Nova Protocol','https://placehold.co/64x64/6366f1/ffffff?text=N','Ethereum','1,000,000,000','50,000','0.005','ETH', NOW() + INTERVAL '30 days',18432,'Nova Protocol is a next-generation DeFi infrastructure layer enabling frictionless cross-chain liquidity. Powered by AI-driven routing and zero-knowledge proofs.','https://novaprotocol.io',true),
  ('PEPE','Pepe','https://assets.coingecko.com/coins/images/29850/small/pepe-token.jpeg','Ethereum','420,690,000,000,000','1,000,000','0.003','ETH', NOW() + INTERVAL '30 days',52841,'The most memeable memecoin in existence. The Pepe community is rising — are you ready to claim your share?','https://pepe.vip',false),
  ('WIF','dogwifhat','https://assets.coingecko.com/coins/images/33566/small/dogwifhat.jpg','Solana','998,925,066','5,000','0.003','ETH', NOW() + INTERVAL '30 days',31205,'The dog with the hat. One of the fastest growing meme coins on Solana now expanding to Ethereum with a massive airdrop for early adopters.','https://dogwifhat.com',false),
  ('FLOKI','FLOKI','https://assets.coingecko.com/coins/images/16746/small/PNG_image.png','Ethereum','10,000,000,000,000','500,000','0.004','ETH', NOW() + INTERVAL '30 days',28973,'FLOKI is the utility token of the Floki Ecosystem — transcending its meme origins with real DeFi utility.','https://floki.com',false),
  ('ONDO','Ondo Finance','https://assets.coingecko.com/coins/images/26580/small/ONDO.png','Ethereum','10,000,000,000','2,500','0.006','ETH', NOW() + INTERVAL '30 days',14821,'Ondo Finance brings institutional-grade financial products to DeFi — tokenized treasuries, bonds, and yield products.','https://ondo.finance',false)
ON CONFLICT DO NOTHING;
...
ALTER TABLE airdrop_tokens DISABLE ROW LEVEL SECURITY;
